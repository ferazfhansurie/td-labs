...
class Sliver_SearchBar extends StatefulWidget {
  String? value;
  ...
  @override
  _Sliver_SearchBarState createState() => _Sliver_SearchBarState();
}

class _Sliver_SearchBarState extends State<Sliver_SearchBar> {
