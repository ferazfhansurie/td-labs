...
import 'package:tdlabs/widgets/search/search_bar5.dart';

typedef StringCallback = Function(String value);

class EBookPocCustomSliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  bool? isCatalog;
  bool? mapShown;
  EBookPocCustomSliverAppBarDelegate(
