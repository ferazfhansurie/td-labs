...
import 'package:tdlabs/screens/wellness/checkout_wellness_confirmation.dart';
...
class CheckoutWellnessScreen extends StatefulWidget {
  ...
  CheckoutWellnessScreen(
      ...
      : super(key: key);
  @override
  _CheckoutWellnessScreenState createState() => _CheckoutWellnessScreenState();
}

class _CheckoutWellnessScreenState extends State<CheckoutWellnessScreen> {
                            ...
                            Row(
                              children: [
                                Container(
                                  ...
                                  child: (isSwitched)
                                      ? Text(
                                          "$points_used PTS -RM [ $discountPrice2 ]",
                                          overflow: TextOverflow.ellipsis,
                                          style: const TextStyle(
                                              fontFamily: 'Montserrat',
                                              fontSize: 13,
                                      ...
                                      : Text(
                                          "$available_credit RM [ $discountPrice2 ]",
                                          overflow: TextOverflow.ellipsis,
                                          style: const TextStyle(
                                              fontFamily: 'Montserrat',
                                              fontSize: 13,
            ...
            child:   GestureDetector(
              ...
              onTap: () {
                Navigator.of(context)
                  ...
                  return CheckoutWellnessConfirmation(
