...
class WellnessDescriptionScreen extends StatefulWidget {
  int? index;
  Catalog? catalog;
  double? subTotal;
  int? method;
  ...
  @override
  _WellnessDescriptionScreenState createState() =>
      _WellnessDescriptionScreenState();
}

class _WellnessDescriptionScreenState extends State<WellnessDescriptionScreen> {
    ...
    if (mounted) {
      ...
      if (widget.orderQuantityList![index] < 1 || _addList!.isEmpty) {
        setState(() {
          ...
          widget.orderQuantityList![index]; // assign total to product called
          widget.orderList![index]['product_id'] = product.id;
                      ...
                      onPressed: () {
                        ...
                        Navigator.of(context)
                          ...
                          return CheckoutWellnessScreen(
                            ...
                            originalPrice: subTotalController.getSubTotal!.toStringAsFixed(2),
