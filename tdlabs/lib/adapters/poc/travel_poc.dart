...
class TravelPocAdapter extends StatefulWidget {
  final Poc? poc;
  final Color? color;
  final bool? active;
  TravelPocAdapter(
  ...
  @override
  _TravelPocAdapterState createState() => _TravelPocAdapterState();
}

class _TravelPocAdapterState extends State<TravelPocAdapter> {
  Color? reportColor;
  Color? nameColor;
  Widget? reportWidget;
  @override
                ...
                children: [
                   Card(
                    ...
                    child: SizedBox(
                      width: 85,
                      height: 85,
                      child:Image.asset( "assets/images/skypod.jpg",fit: BoxFit.fill,),
                    ),
                  ),
                  Container(
