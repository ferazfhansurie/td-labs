...
import '../../screens/medical/ebook/ebook_form.dart';
      ...
      for (int i = 0; i < widget.vm!.length; i++) {
        _markers.add(
          Marker(
            width: 105,
            height: 105,
            point: LatLng(double.parse(widget.vm![i].latitude!),double.parse(widget.vm![i].longitude!)),
            builder: (ctx) => Container(
              key: const Key('blue'),
                ...
                child: Column(
                  children: [
                    ...
                    FadeInImage.memoryNetwork(
                      ...
                      image: widget.vm![i].vm_image_url!,
                      height: 50,
                    ),
                  ],
                ),
      ...
      for (int i = 0; i < widget.clinic!.length; i++) {
        _markers.add(
          Marker(
            width: 105,
            height: 105,
            point: LatLng(double.parse(widget.clinic![i].latitude),
              ...
              child: GestureDetector(
                ...
                child: Column(
                  children: [
                    ...
                    FadeInImage.memoryNetwork(
                      placeholder: kTransparentImage,
                      image: widget.clinic![i].image_url!,
                      height: 50,
                    ),
                  ],
                ),
                ...
                ? FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      return FlutterMap(
                        ...
                        options: MapOptions(
                          center: LatLng(double.parse(widget.latitude!),
                              double.parse(widget.longitude!)),
                          zoom: 13,
                        ),
                        children: [
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  if (directory.other_phone_no != null&&directory.other_phone_no!.isNotEmpty)
                                    GestureDetector(
                                      onTap: () {
